...
export default function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="layout dark:bg-gray-900 dark:text-white transition-colors duration-200">
      {/* Mobile hamburger button - compact fixed button */}
      <button
        onClick={toggleSidebar}
        className="lg:hidden fixed top-4 left-4 z-30 p-2 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-xl transition-all"
        aria-label="Menu"
      >
      ...
      <nav className={`sidebar dark:bg-gray-800 dark:border-gray-700 transition-all duration-300 ${
        ...
        <div className="sidebar-header dark:border-gray-700 flex flex-col gap-3">
          ...
          <div className="lg:hidden flex flex-col gap-2 pb-3 border-b border-gray-200 dark:border-gray-700">
            <div className="flex items-center gap-2">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-bold text-gray-900 dark:text-white truncate">{selectedGuild?.name || 'RaidBot'}</p>
            ...
            <div className="flex items-center gap-2">
              <select
                ...
                className="w-16 px-2 py-1.5 text-xs rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 border-0 focus:ring-2 focus:ring-purple-500"
              >
          ...
          {/* Desktop user info with avatar, theme toggle and logout */}
      ...
      <main className="main-content dark:bg-gray-900 transition-colors duration-200">
        <div className="container mx-auto p-4 sm:p-6 lg:p-8 pt-16 lg:pt-4">
          {children}
        </div>
      </main>
    </div>
