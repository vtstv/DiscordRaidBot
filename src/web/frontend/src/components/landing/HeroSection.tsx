          ...
          {!user ? (
            <div className="flex flex-col items-center gap-5">
              ...
              <a
                ...
                className="group relative inline-flex items-center gap-3 px-10 py-5 bg-gradient-to-r from-indigo-600 via-blue-600 to-cyan-600 text-white rounded-2xl font-bold text-lg shadow-2xl hover:shadow-blue-500/40 dark:hover:shadow-blue-700/40 transition-all duration-300 overflow-hidden"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-indigo-700 via-blue-700 to-cyan-700 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                ...
                <span className="relative z-10 group-hover:tracking-wide transition-all">Add to Discord</span>
              </a>
