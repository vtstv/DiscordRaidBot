      ...
      <Layout>
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center">
            ...
            <p className="mt-4 text-gray-600 dark:text-gray-400">Loading compositions...</p>
          </div>
        </div>
      </Layout>
    );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Active raid compositions for upcoming events
          </p>
        </div>
        ...
        {events.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              Create a composition for an upcoming event to see it here
            </p>
            <button
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                      ...
                      <span>
                        {event.raidPlan?.groups?.length || 0} group(s)
                      </span>
                    </div>
