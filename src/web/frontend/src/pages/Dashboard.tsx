      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">Overview of your server's events and statistics</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            ...
            <button
              ...
              className="flex items-center gap-3 p-4 bg-white text-gray-700 rounded-2xl shadow-sm hover:shadow-lg transition-all hover:scale-105 border border-gray-200"
            >
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 hover:shadow-lg transition-shadow">
              ...
              <div className="text-3xl font-bold text-gray-900">{stats?.totalEvents || 0}</div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-sm font-medium text-gray-600 mb-1">Templates</h3>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 hover:shadow-lg transition-shadow">
              ...
              <div className="text-3xl font-bold text-gray-900">{stats?.totalParticipants || 0}</div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">View All Events</div>
                    <div className="text-sm text-gray-600">Manage your server events</div>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Event Calendar</div>
                    <div className="text-sm text-gray-600">View events in calendar format</div>
                  </div>
                </div>
                <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
