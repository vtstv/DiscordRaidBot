        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:shadow-lg transition-all">
              ...
              <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Total Events</h3>
              <div className="text-3xl font-bold text-gray-900 dark:text-white">{stats?.totalEvents || 0}</div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:shadow-lg transition-all">
              ...
              <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Active Events</h3>
              <div className="text-3xl font-bold text-gray-900 dark:text-white">{stats?.activeEvents || 0}</div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:shadow-lg transition-all">
              ...
              <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Templates</h3>
              <div className="text-3xl font-bold text-gray-900 dark:text-white">{stats?.totalTemplates || 0}</div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:shadow-lg transition-all">
              ...
              <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Total Participants</h3>
              <div className="text-3xl font-bold text-gray-900 dark:text-white">{stats?.totalParticipants || 0}</div>
            </div>
          </div>
